...
<div class="subpage_banner wrap z-index relative">
	<div class="container">
		<h1 class="page-header">Board Page</h1>
	</div>
</div>
<!-- subpage banner -->
	...
	<div class="container">
		<div class="article-layout">
			<form role="form" action="/notice/modify" method="post">
				...
				<input type="hidden" name="n_bno" value='<c:out value="${notice.n_bno}" />'/>
				<div class="article-top">
					<div class="article-reg-top">
						...
						<div class="field2 get-td field-style">
							<input type="text" class="form-stye" name="n_writer" value='<c:out value="${notice.n_writer}" />' readonly>
						</div>
					</div>
					<div class="article-reg-top">
						<div class="field1 get-th field-style">
						...
						<div class="field2 get-td field-style">
							<input type="text" class="form-stye" name="n_title" value="<c:out value="${notice.n_title}" />">
						</div>
					</div>
				</div>
				<div class="get-content">
					<textarea name="n_content" rows="10" id="content-editor" class="content-txtarea"><c:out value="${notice.n_content}" /></textarea>
				</div>
					...
					<div class="bottom_button1">
						...
						<sec:authorize access="isAuthenticated()">
							<c:if test="${pinfo.username eq notice.n_writer}">
								<button type="submit" data-oper="modify" class="button button-submit" onclick="location.href='/notice/modify?n_bno=<c:out value="${notice.n_bno}"/>'">수정</button>
								<button type="submit" data-oper="remove" class="button button-comm">삭제</button>
							</c:if>
						</sec:authorize>
						<button type="submit" data-oper="list" class="button button-comm" onclick="location.href='/notice/list'" style="margin-left:10px;">List</button>
						<!--<a class="button button-comm" href="/notice/list" style="margin-left:10px;">목록</a> -->
					</div>
					<!--복붙 대상-->
				</div>
			</form>
