...
<div class="wrap wrap1 wrap2 z-index relative">
	<div class="container">
		...
		<div class="article-layout">
			<form role="form" action="/travell/register" method="post">
				...
				<div class="article-top">
					...
					<div class="article-reg-top">
						...
						<div class="field2 get-td field-style">
							<select name="area" class="select-style">
					...
					<div class="article-reg-top">
						...
						<div class="field2 get-td field-style">
							<input type="text" class="form-stye" name="kind">
						</div>
					</div>
					<div class="article-reg-top">
						<div class="field1 get-th field-style">
						...
						<div class="field2 get-td field-style">
							<input type="text" class="form-stye" name="address" id="address">
						</div>
					</div>
				</div>
				...
				<div class="article-bottom">
					...
					<div class="bottom_button">
						...
						<a class="button button-comm" href="/travell/list">목록</a>
					</div>
					<!--복붙 대상-->
				</div>
			</form>
