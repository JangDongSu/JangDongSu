	...
	<div class="container">
		...
		<div class="article-layout">
			<form role="form" action="/gallery/modify/" method="post">
				...
				<input type="hidden" name="p_bno" value='<c:out value="${gallery.p_bno}" />'/>
				<div class="article-top">
					<div class="article-reg-top">
						...
						<div class="field2 get-td field-style">
							<input type="text" class="form-stye" name="writer" value='<c:out value="${gallery.writer}" />' readonly>
						</div>
					</div>
					<div class="article-reg-top">
						<div class="field1 get-th field-style">
						...
						<div class="field2 get-td field-style">
							<input type="text" class="form-stye" name="title" value="<c:out value="${gallery.title}" />">
						</div>
					</div>

				</div>
				<div class="get-content">
					<textarea name="content" rows="10" id="content-editor" class="content-txtarea"><c:out value="${gallery.content}" /></textarea>
				</div>
					...
					<div class="bottom_button1">
						...
						<sec:authorize access="isAuthenticated()">
							<c:if test="${pinfo.username eq gallery.writer}">
								<button type="submit" data-oper="modify" class="button button-submit" onclick="location.href='/gallery/modify?p_bno=<c:out value="${gallery.p_bno}"/>'">수정</button>
						...
						<button type="submit" data-oper="list" class="button button-comm" onclick="location.href='/gallery/list'" style="margin-left:10px;">List</button>
						<!--<a class="button button-comm" href="/gallery/list" style="margin-left:10px;">목록</a> -->
					</div>
					<!--복붙 대상-->
				</div>
			</form>
