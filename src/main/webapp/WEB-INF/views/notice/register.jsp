		...
		<form role="form" action="/notice/register" method="post">
			...
			<div class="article-top">
				<div class="article-reg-top">
					...
					<div class="field2 get-td field-style">
						<input type="text" class="form-stye" name="n_title">
					</div>
				</div>
				<div class="article-reg-top">
					<div class="field1 get-th field-style">
					...
					<div class="field2 get-td field-style">
						<input type="text" class="form-stye" name="n_writer" value='<sec:authentication property="principal.username"/>' readonly>
					</div>
				</div>
			</div>
			<div class="get-content">
				<textarea name="n_content"  rows="10" id="content-editor" class="content-txtarea"></textarea>
			</div>
			<div class="article-bottom">
				...
				<div class="bottom_button">
					...
					<a class="button button-comm" href="/notice/list">목록</a>
				</div>
				<!--복붙 대상-->
			</div>
		</form>
						...
						$(".move")
								.on(
										...
										function(e) {
											...
											e.preventDefault();
											actionForm
													.append("<input type='hidden' name='n_bno' value='"
															+ $(this).attr(
																	"href")
															+ "'>");
